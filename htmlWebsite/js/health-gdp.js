...
getData2().then((data) => {
    ...
    const graph = () => {
        ...
        countries
            .on('mouseover', function () {
                ...
                // add data to tooltip_gdp
                two_lines = false
                tooltip_gdp.append('text')
                ...
                // add data to tooltip_gdp: heading in one line and data in another
                tooltip_gdp.append('text')
        ...
        // on scrubber change, update tooltip_gdp if country is clicked
        ...
        // create a tooltip_gdp for countires being hovered over below the legend
        const tooltip_gdp = svg.append('g')
            .attr('class', 'tooltip_gdp')
            .attr('transform', `translate(${width - margin.right + 20}, ${margin.top + 150})`)

        tooltip_gdp.append('rect')
            .attr('width', 150)
            .attr('height', 210)
            .attr('stroke', 'black')
            .attr('stroke-width', 1)
    ...
    // add to DOM
    chart = document.getElementById('gdp_chart');
